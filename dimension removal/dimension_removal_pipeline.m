%% Set population indices for dimension removal.

sourceIdx = 1; % source V1

% Area whose predictive dimensions in source will be removed.
removeArea = 'targetV1';
switch removeArea
    case 'targetV1'
        removeIdx = 2;
...
% Area we will test on with source activity that has had dimensions
% removed.
predictArea = 'V2';
switch predictArea
    case 'targetV1'
